...
var DataTableRowActions = function DataTableRowActions(_ref) {
  ...
  var _useContextHelper = (0, _contextHelper.default)(tableContext, cellContext, fixedLayout),
  ...
  var handleSelect = function handleSelect(selection) {
    if ((0, _lodash.default)(onAction)) {
      onAction(item, selection);
    }

    if (dropdown && (0, _lodash.default)(dropdown.props.onSelect)) {
