...
var DataTable = /*#__PURE__*/function (_React$Component) {
  ...
  function DataTable(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleToggleAll", function (e, _ref) {
      ...
      var selectedDisabledItems = _this.props.selection.filter(function (item) {
        return _this.props.disabledSelection.includes(item);
      });

      var enabledItems = _this.props.items.filter(function (item) {
        return !_this.props.disabledSelection.includes(item);
      });

      var selection = (checked ? [].concat(_toConsumableArray(enabledItems), _toConsumableArray(selectedDisabledItems)) : _toConsumableArray(selectedDisabledItems)).filter(function (item) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleRowToggle", function (item, selected, e) {
      ...
      if (typeof _this.props.onRowChange === 'function') {
        ...
        if (selected) {
          _selection = _this.props.selectRows === 'radio' ? [item] : [].concat(_toConsumableArray(_this.props.selection), [item]);
        } else {
          _selection = (0, _lodash3.default)(_this.props.selection, item);
        }
    ...
    _this.generatedId = (0, _generateId.default)();
    _this.headerRefs = {
      action: [],
      column: [],
      select: []
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      ...
      var numSelected = count(this.props.selection.filter(function (item) {
        return !_this4.props.disabledSelection.includes(item);
      }));
      var numNonHeaderRows = count(this.props.items.filter(function (item) {
        return item.type !== 'header-row' && !_this4.props.disabledSelection.includes(item);
      }));
      ...
      var component = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_tableContext.default.Provider, {
        ...
        var rowId = _this4.getId() && item.id ? "".concat(_this4.getId(), "-").concat(_constants.DATA_TABLE_ROW, "-").concat(item.id) : (0, _generateId.default)();
        return _this4.props.onRenderSubHeadingRow && item.type === 'header-row' ? _this4.props.onRenderSubHeadingRow({
          ...
          disabledSelection: _this4.props.disabledSelection,
          rowActions: RowActions,
          tableId: _this4.getId(),
...
_defineProperty(DataTable, "propTypes", {
   ...
   */
  disabledSelection: _propTypes.default.array,
