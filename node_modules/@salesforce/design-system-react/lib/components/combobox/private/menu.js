...
var Menu = function Menu(_ref) {
  var activeOption = _ref.activeOption,
      ...
      classNameMenuSubHeader = _ref.classNameMenuSubHeader,
      classNameMenu = _ref.classNameMenu,
      inheritWidthOf = _ref.inheritWidthOf,
      inputId = _ref.inputId,
      itemVisibleLength = _ref.itemVisibleLength,
      labels = _ref.labels,
      onRenderMenuItem = _ref.onRenderMenuItem,
      _ref$menuRef = _ref.menuRef,
      menuRef = _ref$menuRef === void 0 ? function () {} : _ref$menuRef,
      menuPosition = _ref.menuPosition,
      maxWidth = _ref.maxWidth,
      onSelect = _ref.onSelect,
      options = _ref.options,
      selection = _ref.selection,
      hasMenuSpinner = _ref.hasMenuSpinner,
      tooltipMenuItemDisabled = _ref.tooltipMenuItemDisabled,
  ...
  var menuOptions = options.map(function (optionData, index) {
    ...
    if (optionData.type === 'separator') {
      return optionData.label ? /*#__PURE__*/_react.default.createElement("li", {
        ...
        className: (0, _classnames.default)('slds-listbox__option-header', classNameMenuSubHeader)
    ...
    if (optionData.type === 'header') {
      return /*#__PURE__*/_react.default.createElement("li", {
        ...
        id: "".concat(inputId, "-listbox-option-").concat(optionData.id),
    ...
    var disabledProps = {};
    var tooltipId = "".concat(inputId, "-listbox-option-help-").concat(optionData.id);
    ...
    var menuItem = {
      'icon-title-subtitle': /*#__PURE__*/_react.default.createElement("span", _extends({
        ...
        role: "option"
      }), optionData.icon && !onRenderMenuItem ? /*#__PURE__*/_react.default.createElement("span", {
        className: "slds-media__figure"
      }, optionData.icon) : null, onRenderMenuItem ? /*#__PURE__*/_react.default.createElement(MenuItem, {
        ...
        title: optionData.label
      }, setBold(optionData.label, inputValue)), /*#__PURE__*/_react.default.createElement("span", {
      ...
      checkbox: /*#__PURE__*/_react.default.createElement("span", _extends({
        ...
        className: "slds-media__body"
      }, onRenderMenuItem ? /*#__PURE__*/_react.default.createElement(MenuItem, {
        assistiveText: assistiveText,
        selected: selected,
        option: optionData
      }) : /*#__PURE__*/_react.default.createElement("span", {
      ...
      }, assistiveText.optionSelectedInMenu) : null, ' ', optionData.type === 'deselect' ? /*#__PURE__*/_react.default.createElement("em", null, optionData.label) : optionData.label)))
    };
    var item;

    if (optionData.disabled && tooltipMenuItemDisabled) {
      var _tooltipMenuItemDisab = tooltipMenuItemDisabled.props,
          content = _tooltipMenuItemDisab.content,
          userDefinedTooltipProps = _objectWithoutProperties(_tooltipMenuItemDisab, ["content"]);
      ...
      item = /*#__PURE__*/_react.default.cloneElement(tooltipMenuItemDisabled, tooltipProps, menuItem[variant]);
    } else {
  ...
  return /*#__PURE__*/_react.default.createElement("ul", {
  ...
  }, labels.noOptionsFound)), hasMenuSpinner && /*#__PURE__*/_react.default.createElement("li", {
    role: "presentation",
    className: "slds-listbox__item"
  }, /*#__PURE__*/_react.default.createElement("div", {
    ...
    assistiveText: {
      label: assistiveText.loadingMenuItems
    },
    hasContainer: false,
    isInline: true,
    size: "x-small"
