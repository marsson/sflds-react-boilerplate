...
var Search = function Search(_ref) {
  var clearable = _ref.clearable,
      ...
      props = _objectWithoutProperties(_ref, ["clearable", "onClear", "onSearch", "placeholder", "assistiveText"]);

  (0, _checkProps.default)(_constants.SEARCH, _objectSpread({
    clearable: clearable,
    onClear: onClear,
    onSearch: onSearch,
    placeholder: placeholder,
    assistiveText: assistiveText
  }, props), _component.default);
