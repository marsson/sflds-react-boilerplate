...
var Icon = function Icon(_ref) {
  var _ref$category = _ref.category,
      category = _ref$category === void 0 ? defaultProps.category : _ref$category,
      className = _ref.className,
      _ref$colorVariant = _ref.colorVariant,
      colorVariant = _ref$colorVariant === void 0 ? defaultProps.colorVariant : _ref$colorVariant,
      ...
      style = _ref.style,
      rest = _objectWithoutProperties(_ref, ["category", "className", "colorVariant", "containerClassName", "containerStyle", "icon", "inverse", "name", "path", "size", "title", "productTheme", "assistiveText", "style"]);

  (0, _checkProps.default)(_constants.ICON, _objectSpread({
    category: category,
    className: className,
  ...
  return /*#__PURE__*/_react.default.createElement("span", {
    ...
    path: path,
    style: styleOverride
  }), mergedAssistiveText ? /*#__PURE__*/_react.default.createElement("span", {
