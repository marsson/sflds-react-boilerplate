...
describe('SLDSColorPicker', function describeFunction() {
  ...
  describe('Accessibility label for toggle button is configured correctly for screen reader', function () {
    it('Use assistive text label if present', function () {
      var label = 'Pick a color';
      var assistiveText = 'Should be read';
      wrapper = mount( /*#__PURE__*/React.createElement(ColorPicker, {
        labels: {
          label: label
        },
    ...
    it('Use label for screen reader if assistive text is not provided', function () {
      var label = 'Pick a color';
      wrapper = mount( /*#__PURE__*/React.createElement(ColorPicker, {
        labels: {
          label: label
