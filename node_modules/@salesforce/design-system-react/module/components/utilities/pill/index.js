...
var Pill = function Pill(_ref3) {
  var _ref3$assistiveText = _ref3.assistiveText,
      assistiveText = _ref3$assistiveText === void 0 ? defaultProps.assistiveText : _ref3$assistiveText,
      _ref3$labels = _ref3.labels,
      labels = _ref3$labels === void 0 ? defaultProps.labels : _ref3$labels,
      _ref3$events = _ref3.events,
      events = _ref3$events === void 0 ? defaultProps.events : _ref3$events,
      avatar = _ref3.avatar,
      bare = _ref3.bare,
      ...
      requestFocus = _ref3.requestFocus,
      active = _ref3.active;
  var mergedAssistiveText = assign({}, defaultProps.assistiveText, assistiveText);
  var mergedLabels = assign({}, defaultProps.labels, labels);
  return /*#__PURE__*/React.createElement(SLDSPill, {
    ...
    onClick: typeof events.onClick === 'function' ? function (event) {
      if (events.onClick) {
        events.onClick(event, _objectSpread({}, eventData));
      }
    } : null,
    onFocus: function onFocus(event) {
      if (events.onFocus) {
        events.onFocus(event, _objectSpread({}, eventData));
      }
    },
    ...
    ref: function ref(component) {
      if (requestFocus && active) {
        events.onRequestFocus(undefined, {
          ref: component
        });
      }
    }
