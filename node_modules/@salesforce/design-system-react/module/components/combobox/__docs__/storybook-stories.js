...
}).add('Inline Single Selection Invalid', function () {
  return /*#__PURE__*/React.createElement(InlineSingleInvalid, {
    action: action
  });
...
}).add('Snapshot Inline Single Selection Invalid', function () {
  return /*#__PURE__*/React.createElement(SnapshotInlineSingleInvalid, {
    action: action
  });
