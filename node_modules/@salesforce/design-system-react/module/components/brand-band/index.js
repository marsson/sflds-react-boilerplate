...
import classNames from '../../utilities/class-names'; // This component's `checkProps` which issues warnings to developers about properties when in development mode (similar to React's built in development tools)
...
var BrandBand = /*#__PURE__*/function (_React$Component) {
  ...
  function BrandBand(props) {
    ...
    checkProps(BRAND_BAND, _this.props);
