...
var Breadcrumb = function Breadcrumb(_ref) {
  var _ref$assistiveText = _ref.assistiveText,
      ...
      id = _ref.id,
      overflowDropdownMenu = _ref.overflowDropdownMenu,
      styleContainer = _ref.styleContainer,
      trail = _ref.trail,
      rest = _objectWithoutProperties(_ref, ["assistiveText", "id", "overflowDropdownMenu", "styleContainer", "trail"]);

  checkProps(BREADCRUMB, _objectSpread({
    assistiveText: assistiveText,
    id: id,
    overflowDropdownMenu: overflowDropdownMenu,
    styleContainer: styleContainer,
    trail: trail
  }, rest), componentDoc);
  var assistiveTextLabel = typeof assistiveText === 'string' ? assistiveText : _objectSpread(_objectSpread({}, defaultProps.assistiveText), assistiveText).label;
